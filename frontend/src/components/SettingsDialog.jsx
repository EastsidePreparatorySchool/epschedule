...
export default function SettingsDialog({ sharePhoto: initialSharePhoto, onClose }) {
    ...
    <div className="dialog-overlay" onClick={(e) => e.target === e.currentTarget && onClose()}>
      <div className="dialog">
        ...
        <div className="settings-row">
          ...
          <p className="settings-note">Note that you will still be able to see your own photo</p>
        </div>
